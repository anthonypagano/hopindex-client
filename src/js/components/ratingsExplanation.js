...
export default function RatingsExplanation() {
    return (
        <section>
            ...
            <p>The range for ratings are whole numbers with 1 being the beer you never want to have again 5 being the best. A more detailed explanation for each level follows.</p>
            ...
            <p>4 - Good stuff! You finished what you were served and asked for more. At this level you'd actively buy it if you saw it on a shelf or order it if you saw it on a menu.</p>
